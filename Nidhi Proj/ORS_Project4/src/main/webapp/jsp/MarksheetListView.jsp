            ...
            <table width="100%" align="center">
                <tr>
                    ...
                    <%=HTMLUtility.getList("rollNo123",String.valueOf(bean.getId()),l)%>
                     &nbsp;
                     <%-- <label>Result :</label>
                     <input type="text" name="result" placeholder="Enter Your Result" value="<%=ServletUtility.getParameter("result", request)%>"> --%>
                     <label>total :</label> 
                     <input type="number" name="tot" placeholder="Enter your number" value=<%=DataUtility.getString(request.getParameter("tot") == null ? ""
					: DataUtility.getString(request.getParameter("tot")))%>>
					...
					while(it.hasNext())
							{
							 bean = it.next();
					            ...
					            if(t==total){
					%>
					<%-- <label>total</label><input type="number"name="total" value="<%=total %>">
 --%>
                <tr align="center">
