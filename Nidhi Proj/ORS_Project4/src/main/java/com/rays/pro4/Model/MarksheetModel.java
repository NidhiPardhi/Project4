...
public class MarksheetModel {
	...
	/**
	 * Find record from database by RollNo
	 * @param rollNo
	 * @return
	 * @throws ApplicationException
	 */
	...
	public List search(MarksheetBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		if (bean != null) {
			 ...
			 * sql.append(" AND Physics>33 AND Chemistry>33 AND Maths>33"); }
			 * 
			 * if(bean.getResult().equalsIgnoreCase("fail")) {
			 * sql.append("AND Physics<33 AND Chemistry<33 AND Maths<33 "); }
			 */
	...
	/**
	 * Get MeritList records from database
	 * @param pageNo
	 * @param pageSize
	 * @return
	 * @throws ApplicationException
