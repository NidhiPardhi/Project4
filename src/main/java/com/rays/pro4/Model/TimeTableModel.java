...
//			throw new ApplicationException("Exception : Exception in add timetable");
	...
	public void update(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
	 ...
	 /**
		 * Find Record from database with id 
		 * @param pk
		 * @return
		 * @throws ApplicationException
		 */
	...
	/**
	 * Find timetable from database record by CourseId,SubjectId,Semester
	 * @param CourseId
	 * @param SubjectId
	 * @param semester
	 * @return
	...
	/**
	 * Find Timetable from database by CourseId,Semester,Exam date
	 * @param CourseId
	 * @param Semester
	 * @param ExamDate
	 * @return
	...
	/**
	 * Find record from database by semester
	 * @param CourseId
	 * @param SubjectId
	 * @param semester
	 * @param ExamDAte
	...
	/**
	 * Find timetable record from database by Course Name
	 * @param CourseId
	 * @param ExamDate
	 * @return
	 */
