...
public class UserModel {
	...
	/**
	 * Find record from Database by LoginId
	 * @param login
	 * @return
	 * @throws ApplicationException
	 */
	public UserBean findByLogin(String login) throws ApplicationException {
	 ...
	 /**
		 * Find Record from database by id 
		 * @param pk
		 * @return
		 * @throws ApplicationException
		 */
	...
	/**
	 * Get record of roles from the database
	 * @param bean
	 * @return
	 * @throws ApplicationException
	 */
	...
	/**
	 * Authenticate the user record from the database 
	 * @param login
	 * @param password
	 * @return
	 * @throws ApplicationException
	...
	/**
	 * ChangePassword from the record in Database
	 * @param id
	 * @param oldPassword
	 * @param newPassword
	 * @return
	...
	/**
	 * Register the user by adding records in database
	 * @param bean
	 * @return
	 * @throws ApplicationException
	 * @throws DuplicateRecordException
	...
	/**
	 * Forget Password from the record in Database
	 * @param login
	 * @return
	 * @throws ApplicationException
	 * @throws RecordNotFoundException
